    ...
    <>
      <div className='form-wrapper'>
        <form onChange={handleChange} onSubmit={handleSubmit}>
          ...
          <select name="minYear" id="minYear" defaultValue="">
            <option value="">Min Year</option>
            {year.map((year, index) => 
              <option key={index} value={year}>{year}</option>
            )}
          </select>
          <select name="maxYear" id="maxYear" defaultValue="">
            {year.map((year, index) => 
              <option key={index} value={year}>{year}</option>
            )}
          ...
          <label htmlFor="postalCode">Postal Code or City</label>
          <input id="postalCode" type="text" name="location" placeholder="S7M 8A2"></input>
